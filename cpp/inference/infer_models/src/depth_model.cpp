...
bool LiteMonoDepthModel::init(std::map<std::string, std::string> model_path,
                              int                                raw_img_w,
                              int                                raw_img_h,
                              bool                               is_normalize,
                              bool                               use_gpu) {
    ...
    APP_INFO("LiteMonoDepthModel initialized successfully");
    return true;
}
...
void LiteMonoDepthModel::cvMatPostProcess(InferOutputContext & infer_output_context) {
